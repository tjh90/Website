...
public class AnascrambleModel {
  ...
  /// @return true if the given letter (case-insensitive) has not already been assigned to a known
  /// position.
  ...
  /// @return a list parallel to [letters], where each element is true if the corresponding letter
  /// has already been assigned to a known position.
