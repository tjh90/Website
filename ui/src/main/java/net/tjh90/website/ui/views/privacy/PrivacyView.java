...
public class PrivacyView extends VerticalLayout implements HasTitle {
  ...
  private static final String PRIVACY_TEXT =
      "This website uses essential cookies required for its operation which cannot be disabled. The cookies include:";
  private static final String JSESSIONID_TEXT =
      "JSESSIONID - maintains a user session while navigating the site.";
